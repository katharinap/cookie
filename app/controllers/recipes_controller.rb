class RecipesController < ApplicationController
  ...
  private
    ...
    def recipe_params
      params.require(:recipe).permit(:name, ingredients_attributes: [:id, :value, :_destroy], steps_attributes: [:id, :description, :_destroy], references_attributes: [:id, :url, :_destroy])
    end
